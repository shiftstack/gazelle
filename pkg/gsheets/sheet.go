...
func (s *Sheet) getID() int64 {
	innerMap := map[string]int64{
		...
		"periodic-ci-openshift-release-master-ci-4.10-e2e-openstack-ovn":                             707522239,
		...
		"periodic-ci-openshift-release-master-ci-4.9-e2e-openstack-kuryr":                            1013840714,
		...
		"periodic-ci-openshift-release-master-ci-4.9-upgrade-from-stable-4.8-e2e-openstack-upgrade":  1466994961,
		...
		"periodic-ci-openshift-release-master-ci-4.8-e2e-openstack-kuryr":                            1172813220,
		...
		"periodic-ci-openshift-release-master-ci-4.7-e2e-openstack-kuryr":                            2073080389,
...
func (s *Sheet) getName() string {
	innerMap := map[string]string{
		...
		"periodic-ci-openshift-release-master-ci-4.10-e2e-openstack-ovn":                             "OCP 4.10 OVN",
		...
		"periodic-ci-openshift-release-master-ci-4.9-e2e-openstack-kuryr":                            "Kuryr 4.9",
		...
		"periodic-ci-openshift-release-master-ci-4.9-upgrade-from-stable-4.8-e2e-openstack-upgrade":  "4.9 upgrade",
		...
		"periodic-ci-openshift-release-master-ci-4.8-e2e-openstack-kuryr":                            "Kuryr 4.8",
		...
		"periodic-ci-openshift-release-master-ci-4.7-e2e-openstack-kuryr":                            "Kuryr 4.7",
